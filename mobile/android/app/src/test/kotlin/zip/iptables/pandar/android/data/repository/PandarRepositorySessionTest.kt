...
private class RecoveryApi : ImmediateApi() {
    ...
    companion object {
        private const val RECOVERY_JOB = """
            {"id":"job-1","tenant_id":"tenant-a","printer_id":"printer-1","agent_id":"agent-1","artifact_id":"artifact-1","command_id":"command-1","status":"queued","error":null,"created_at":"created","updated_at":"updated","print":{"status":"pending","printer_state":null,"progress_percent":null,"remaining_time_minutes":null,"current_layer":null,"total_layers":null,"active_file":null,"last_progress_percent":null,"last_layer":null,"error":null,"started_at":null,"finished_at":null,"updated_at":null},"command":{"id":"command-1","kind":"print_project_file","status":"queued"},"artifact":{"id":"artifact-1","tenant_id":"tenant-a","filename":"part.3mf","content_type":"model/3mf","size_bytes":1,"metadata":null,"created_at":"created"},"material":{"ams_mapping":null,"ams_mapping2":null,"ams_mapping_info":null,"filament_usage":[]}}
        """
