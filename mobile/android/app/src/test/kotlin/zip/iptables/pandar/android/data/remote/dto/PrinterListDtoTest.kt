...
class PrinterListDtoTest {
    ...
    @Test fun parses_full_printer_with_materials() {
        ...
        {"printers":[{
          ...
          "name":"Garage A1","model":"A1 Mini","status":"running",
          ...
          "materials":{
            "ams_units":[{"unit_id":"0","humidity":"2","trays":[
              {"tray_id":"0","type":"PLA","color":"#FFFFFF","name":"White","global_tray_id":1,"remaining_estimate":"100","exists":true}
            ]}],
            "external_spools":[{"external_id":"0","type":"PETG","color":"#000000","global_tray_id":4}],
            "active_tray":{"kind":"ams","ams_id":"0","tray_id":"0","global_tray_id":1},
        ...
        assertEquals("Garage A1", p.name)
        assertEquals("A1 Mini", p.model)
        ...
        assertEquals(1, tray.globalTrayId)
        ...
        assertEquals(1, materials.activeTray?.globalTrayId)
    }
