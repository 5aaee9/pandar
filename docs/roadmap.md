...
- After deploying the updated Agent, retry an operator-approved X2D print to confirm the leaf-only BRTC path succeeds end to end; keep real file uploads outside automated validation.
