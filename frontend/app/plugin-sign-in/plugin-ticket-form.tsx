...
export function PluginTicketForm({ action, redirectUrl, selectedTenant }: PluginTicketFormProps) {
  ...
  return (
    <form action={action} className="grid gap-3 px-4 py-4">
      ...
      <label className="grid gap-1 text-sm">
        <span className="text-xs font-medium text-slate-500">Local callback URL</span>
        <input
