ALTER TABLE printers ADD COLUMN state_revision BIGINT NOT NULL DEFAULT 1 CHECK (state_revision >= 1);
ALTER TABLE printers ADD COLUMN print_task_generation BIGINT NOT NULL DEFAULT 0 CHECK (print_task_generation >= 0);
ALTER TABLE printers ADD COLUMN print_error_generation BIGINT NOT NULL DEFAULT 0 CHECK (print_error_generation >= 0);
ALTER TABLE printers ADD COLUMN print_job_attr BIGINT;
ALTER TABLE printers ADD COLUMN print_error_task_generation BIGINT;
