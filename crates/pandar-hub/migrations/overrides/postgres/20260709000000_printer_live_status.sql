...
ALTER TABLE printers ADD COLUMN print_progress_percent BIGINT;
ALTER TABLE printers ADD COLUMN print_remaining_time_minutes BIGINT;
ALTER TABLE printers ADD COLUMN print_current_layer BIGINT;
ALTER TABLE printers ADD COLUMN print_total_layers BIGINT;
