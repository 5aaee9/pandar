...
- [0.1.3 changelog](CHANGELOG.md): release highlights, distribution channels, and known limitations.
...
The `v0.1.3` release publishes native Linux amd64, macOS amd64/arm64, and Windows amd64 CLI/plugin/BambuSource archives plus the Windows Studio hook bundle on [GitHub Releases](https://github.com/ProjectPandar/pandar/releases/tag/v0.1.3), Hub and Web images as `ghcr.io/projectpandar/pandar/hub:v0.1.3` and `ghcr.io/projectpandar/pandar/web:v0.1.3`, and Helm chart `0.1.3` at `oci://ghcr.io/projectpandar/pandar/chart/pandar`.

Desktop archives are unsigned and accompanied by SHA-256 sidecars. Read the [installation guide](docs/release-installation.md) and [current compatibility evidence](docs/compatibility/release-artifacts.md) before production use.
