...
- [0.1.1 changelog](CHANGELOG.md): release highlights, distribution channels, and known limitations.
...
## Planned release 0.1.1

The planned `v0.1.1` tag will publish native Linux amd64, macOS amd64/arm64, and Windows amd64 CLI/plugin/BambuSource archives plus the Windows Studio hook bundle on [GitHub Releases](https://github.com/ProjectPandar/pandar/releases/tag/v0.1.1), Hub and Web images as `ghcr.io/projectpandar/pandar/hub:v0.1.1` and `ghcr.io/projectpandar/pandar/web:v0.1.1`, and Helm chart `0.1.1` at `oci://ghcr.io/projectpandar/pandar/chart/pandar`.
